...
**奶茶大亨**是一款为商科体验课设计的多人经营沙盘。老师负责创造市场，学生负责接受市场的“毒打”：定价、备货、营销、争夺客流，并在突发事件揭晓后见证排行榜重新洗牌。

它不要求安装 App，也不需要搭建业务服务器。打开网页、分享教室号，一场迷你商业战争就可以开始。

## ✨ 课堂里会发生什么

- **老师开房控场**：创建教室、设置轮数、开始比赛、揭晓事件并统一结算。
- **学生组队经营**：每支公司用一台设备加入，决定售价、进货量和营销预算。
- **市场实时竞争**：价格吸引力、营销效率和有限客流共同决定销量。
- **突发事件搅局**：成本上涨、需求变化、库存损失……昨天的冠军今天可能现金见底。
...
| 决策 | 可选范围 | 需要思考 |
| --- | ---: | --- |
| 售价 | ¥8–24 / 杯 | 贵了没人买，便宜了不赚钱 |
| 进货 | 0–200 杯 | 卖完是实力，剩下是损耗 |
| 营销 | ¥0–200 | 花钱能抢客流，但不能保证回本 |

此外，每轮还有 **¥120 固定成本**，基础原料成本为 **¥4/杯**。鲜奶不会等到下一轮，未售库存全部报废；现金也没有“不能为负”的主角光环。

市场份额由价格、营销和当轮事件共同决定。真正重要的不是猜中一次，而是能否根据结果不断调整策略。

## 🧑‍🏫 推荐课堂节奏

1. **组建公司**：确定公司名和队内分工。
2. **读取市场**：观察上一轮结果，讨论竞争对手可能的策略。
3. **提交决策**：完成定价、进货和营销配置。
4. **揭晓事件**：老师翻开本轮市场事件。
